...
$lang = array_merge($lang, array(
    ...
    'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Salli yhteydet SMTP-palvelimelle, jossa on itse allekirjoitettu SSL-sertifikaatti.<em><strong>Varoitus:</strong> Itse allekirjoitettujen SSL-sertifikaattien salliminen voi vaarantaa tietoturvan.</em>',
    ...
    'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Vaadi SMTP-palvelimen käyttämän SSL-sertifikaatin varmistus.<em><strong>Varoitus:</strong> Yhdistäminen palvelimeen, jossa on vahvistamaton SSL-sertifikaatti voi vaarantaa tietoturvan.</em>',
    'SMTP_VERIFY_PEER_NAME'			=> 'Vahvista SMTP-palvelimen osoite',
    'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Vaadi SSL / TLS -yhteyttä käyttävien SMTP-palvelimien osoitteen varmistus.<em><strong>Varoitus:</strong> Yhdistäminen vahvistamattomiin palvelimiin voi vaarantaa tietoturvan.</em>',
