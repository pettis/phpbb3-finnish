...
$lang = array_merge($lang, array(
	...
	'DISPLAY_POSTING'			=> 'Näytetään viestin lähetyssivulla',
	'DISPLAY_POSTING_NO'		=> 'Ei näytetä viestin lähetyssivulla',

	'EDIT_ICONS'				=> 'Muokkaa kuvakkeita',
	'EDIT_SMILIES'				=> 'Muokkaa hymiöitä',
	'EMOTION'					=> 'Tunne',
	'EXPORT_ICONS'				=> 'Luo kuvakepaketti',
	'EXPORT_ICONS_EXPLAIN'		=> '%sNapsauttamalla tätä linkkiä, käyttämiesi kuvakkeiden tiedot pakataan <samp>icons.pak</samp>-tiedostoon, jonka avulla voit luoda latauksen jälkeen <samp>.zip</samp>- tai <samp>.tgz</samp>-tiedoston, jossa on kaikki kuvakkeesi ja tämä <samp>icons.pak</samp>-konfigurointitiedosto%s.',
	'EXPORT_SMILIES'			=> 'Luo hymiöpaketti',
	'EXPORT_SMILIES_EXPLAIN'	=> '%sNapsauttamalla tätä linkkiä, käyttämiesi hymiöiden tiedot pakataan <samp>smilies.pak</samp>-tiedostoon, jonka avulla voit luoda latauksen jälkeen <samp>.zip</samp>- tai <samp>.tgz</samp>-tiedoston, jossa on kaikki hymiösi ja tämä <samp>smilies.pak</samp>-konfigurointitiedosto%s',
	...
	'SMILIES_NOT_DISPLAYED'		=> 'Näitä hymiöitä ei näytetä viestin kirjoitussivulla',
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Tässä hallintapaneelissa voit lisätä, muokata ja poistaa sanoja, jotka sensuroidaan automaattisesti. Käyttäjät voivat kuitenkin rekisteröidä tunnuksia, joissa on kiellettyjä sanoja. Jokerimerkkien (*) käyttö nimissä on sallittua.',
