...
$lang = array_merge($lang, array(
	'ACP_IMAGESETS_EXPLAIN'	=> 'Kuvapaketteihin kuuluvat kaikki keskustelufoorumilla käytössä olevat kuvat, mukaan lukien myös käytettävästä tyylistä riippumattomat kuvat. Voit ladata kuvapaketteja koneellesi, muokata niitä, poistaa ja halutessasi lisätä uusia paketteja.',
	...
	'ACP_TEMPLATES_EXPLAIN'	=> 'Mallineet sisältävät kaiken tarvittavan kuvauksen sivun rakentamiseksi. Täällä voit muokata olemassa olevia mallineita, poistaa, viedä, tuoda uusia ja esikatsella. Voit myös muokata BBCoden käyttämää koodia.',
	...
	'ADD_STYLE'				=> 'Luo tyyli',
	'ADD_STYLE_EXPLAIN'		=> 'Täällä voit luoda uuden tyylin. Palvelimen asetuksista ja tiedostojen oikeuksista riippuen sinulla voi olla lisäasetuksia käytössäsi. Voit esimerkiksi käyttää uden tyylin pohjanan jotain vanhaa tyyliä. Voit myös mahdollisesti siirtää suoraan palvelimelle tai tuoda tyylin arkistotiedostoon (store-hakemistosta). Mikäli siirrät tai lataat tyylin arkistoon. Sen nimi määritellään automaattisesti.',
	'ADD_TEMPLATE'			=> 'Luo malline',
	'ADD_TEMPLATE_EXPLAIN'	=> 'Täällä voit lisätä uuden mallineen. Palvelimen asetuksista ja tiedostojen oikeuksista riippuen sinulla voi olla lisäasetuksia käytössäsi. Voit esimerkiksi käyttää uden tyylin pohjanan jotain vanhaa mallinea. Voit myös mahdollisesti siirtää suoraan palvelimelle tai tuoda mallineen arkistotiedostoon (store-hakemistosta). Mikäli siirrät tai lataat mallineen. Sen nimi voidaan vaihtoehtoisesti ottaa myös arkistotiedoston nimestä.',
	'ADD_THEME'				=> 'Luo teema',
	'ADD_THEME_EXPLAIN'		=> 'Täällä voit luoda uuden teeman. Palvelimen asetuksista ja tiedostojen oikeuksista riippuen sinulla voi olla lisäasetuksia käytössäsi. Voit esimerkiksi käyttää uden teeman pohjanan jotain vanhaa teemaa. Voit myös mahdollisesti siirtää suoraan palvelimelle tai tuoda teeman arkistotiedostoon (store-hakemistosta). Mikäli siirrät tai lataat teeman. Sen nimi voidaan vaihtoehtoisesti ottaa myös arkistotiedostosta (tämän tehdäksesi jätä nimi tyhjäksi)',
	...
	'CACHE_FILENAME'				=> 'Mallinetiedosto',
	...
	'DETAILS'					=> 'Tiedot',
	'DIMENSIONS_EXPLAIN'		=> 'Valitsemalla kyllä tähän voit lisätä leveys-/korkeusarvot.',
	...
	'EDIT_DETAILS_THEME_EXPLAIN'		=> 'Täällä voit muoksta teemaan liittyviä yksityiskohta, kuten sen nimeä. Sinulla voi olla mahdollisuus siirtää tyylitiedoston tallennuspaikka tiedostojärjestelmästä tietokantaan, tai päinvastoin. Tämä vaihtoehto riippuu palvelimen PHP-asetuksista sekä siitä, voiko palvelin kirjoittaa tyylitiedostoon.',
	...
	'EDIT_TEMPLATE_EXPLAIN'				=> 'Täällä voit muokata mallinepakettia suoraan. Huomaa, että nämä muutokset ovat pysyviä, eikä niitä voida perua sen jälkeen, kun olet lähettänyt muutokset. Mikäli PHP voi kirjoittaa palvelimen tiedostoihin, kaikki muokkaukset tehdään suoraan niihin. Mikäli PHP ei voi kirjoittaa tiedostoihin, muokkaukset tehdään tietokantaan ja vain sitä muokataan. Ole huolellinen muokatessasi mallinepakettia. Muista sulkea kaikki lausekkeet {XXXX} ja suhteelliset käskyt.',
	...
	'IMAGESET_ERR_NAME_CHARS'	=> 'Kuvapaketin nimessa voi olla vain kirjaimia, numeroita, -, +, _ ja välilyöntejä',
	...
	'INACTIVE_STYLES'		=> 'Tyylit, jotka eivät ole käytössä',
    ...
    'KEEP_IMAGESET'             => 'Säilytä kuvapaketti “%s”',
    'KEEP_TEMPLATE'             => 'Säilytä malline “%s”',
    'KEEP_THEME'                => 'Säilytä teema “%s”',
	...
	'REQUIRES_IMAGESET'			=> 'Tämä tyyli vaatii kuvapaketin %s olevan asenenttu.',
	'REQUIRES_TEMPLATE'			=> 'Tämä tyyli vaatii mallinepaketin %s olevan asennettu.',
	'REQUIRES_THEME'			=> 'Tämä tyyli vaatii teeman %s olevan asennettu.',
	...
	'TEMPLATE_ADDED'			=> 'Mallinepaketti on lisätty ja tallennettu tiedostojärjestelmään.',
	...
	'TEMPLATE_ERR_NAME_CHARS'	=> 'mallineen nimi voi koostua vain kirjaimista, numeroista, -, +, _ ja välilyönneistä',
	'TEMPLATE_ERR_NAME_EXIST'	=> 'Tämän niminen mallinepaketti on jo olemassa',
	'TEMPLATE_ERR_NAME_LONG'	=> 'Mallineen nimi ei voi olla 30 merkkiä pidempi.',
	...
	'TEMPLATE_EXPORT_EXPLAIN'	=> 'Täällä voit viedä mallinepaketin arkistoon. Tämä arkisto pitää sisällään kaiken tarvittavan tiedon, jotta sen voi asentaa toiselle keskustelufoorumille. Voit valita lataatko tiedoston omalle koneellesi vai tallennatko sen store-hakemistoon myöhmpää käyttöä varten.',
	'TEMPLATE_EXPORTED'			=> 'Mallineet on viety onnistuneesti ja tallennettu %s',
	'TEMPLATE_FILE'				=> 'Mallinetiedosto',
	'TEMPLATE_FILE_UPDATED'		=> 'Mallinetiedosto on päivitetty.',
	...
	'THEME_EDITOR'				=> 'Raaka CSS-teemaeditori',
	'THEME_EDITOR_HEIGHT'		=> 'Teema editorin korkeus',
	'THEME_ERR_ARCHIVE'			=> 'Ole hyvä ja valitse arkistointitapa',
	'THEME_ERR_CLASS_CHARS'		=> 'Vain kirjaimet, numerot ja ., :, - ja # on sallittu luokkien nimissä.',
	'THEME_ERR_COPY_LONG'		=> 'Tekijänoikeustiedot eivät voi olla 60 merkkiä pidemmät',
	'THEME_ERR_NAME_CHARS'		=> 'Teeman nimessä voi olla vain kirjaimia, numeroita, -, +, _ ja välilyöntejä',
	...
	'THEME_FILE'				=> 'Teematiedosto',
	'THEME_EXPORT'				=> 'Vie teema',
	'THEME_EXPORT_EXPLAIN'		=> 'Täällä voit viedä teeman arkistoon. Tämä arkisto pitää sisällään kaiken tarvittavan tiedon, jotta sen voi asentaa toiselle keskustelufoorumille. Voit valita lataatko tiedoston omalle koneellesi vai tallennatko sen store-hakemistoon myöhmpää käyttöä varten.',
