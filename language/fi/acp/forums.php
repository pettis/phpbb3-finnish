...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'Keskustelufoorumin rakenne perustuu alueisiin. Kategoriat ovat alueen tyyppejä. Jokaisella alueella voi olla rajoittamaton määrä sisäalueita ja voit määritellä voidaanko jokaiseen lähettää viesti (Käyttäytyykö se esimerkiksi samalla tavalla, kuin kategoria). Täällä voit lisätä, muokata, poistaa, lukita ja vapauttaa yksittäisiä alueita ja asettaa joitain muita asetuksia. Voit myös synkronoida viestit uudelleen, mikäli ne ovat menneet sekaisin. <strong>Uudelle alueelle tulee kopioida tai määritellä käsin oikeudet, jotta ne tulevat näkyviin.</strong>',
	...
	'FORUM_DESC'						=> 'Kuvaus',
	'FORUM_DESC_EXPLAIN'				=> 'Kaikki kuvaukset näytetään sellaisenaan. Jos valittu alueen tyyppi on kategoria, kuvausta ei käytetä.',
	...
	'FORUM_RULES_LINK_EXPLAIN'			=> 'Voit lisätä URL:in sivuun tai viestiin, jossa on tämän alueen säännöt. Tämä asetus ohittaa kirjoittamasi säännöt.',
