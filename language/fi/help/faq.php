...
$lang = array_merge($lang, array(
    ...
    'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=> '“Poista kaikki foorumin evästeet” poistaa evästeet, jotka ovat phpBB:n luomia. Ne tunnistavat sinut ja pitävät sinut kirjautuneena foorumille. Evästeet tarjoavat myös toimintoja, kuten luettujen seurantaa, jos ne ovat foorumin ylläpitäjän käyttöönottamia. Jos sinulla on sisään tai uloskirjautumisen kanssa ongelmia, foorumin evästeiden poistaminen voi auttaa.',
    'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> 'Mitä “Poista kaikki foorumin evästeet” tekee?',
