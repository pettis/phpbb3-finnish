...
$help = array(
	...
	array(
		...
		1 => 'Poista evästeet -linkki poistaa phpBB3:n luomat evästeet, jotka pitävät huolen tunnistautumisestasi, kirjautumisestasi sisään ja myös pitää kirjaa luetuista viesteistä, mikäli ylläpitäjä on näin määritellyt.',
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Mikäli vaihdoit aikavyöhykkeen varmasti oikeaksi, todennäköisin syy on kesäaika, joka on yleisesti käytössä Suomessa. Keskustelufoorumia ei ole suunniteltu vaihtamaan tuota aikaa automaattisesti, joten kesällä tuo aika voi heittää tunnilla normaaliin aikaan verrattuna.'
	),
	array(
		0 => 'Kieltäni ei näy luettelossa!',
		1 => 'Todennäköisin syy on se, että yläpitäjä ei ole asentanut kielipakettia tai kukaan ei ole vielä kääntänyt sitä kielellesi. Kysy ylläpitäjiltä, josko he voisivat asentaa haluamasi kielen. Mikäli käännöstä ei ole olemassa, voit vapaasti kääntää sen myös itse. Lisätietoja tästä saat phpBB-ryhmän nettisivuilta (Katso sivun alapuolella olevaa linkkiä).'
	),
	array(
	...
	array(
		...
		1 => 'Lähettääksesi uuden viestin, napsauta asiaan kuuluvaa nappulaa. Saatat joutua kirjautumaan sisään ennen kuin voit lähettää viestin. Mitä voit tehdä alueilla on lueteltuna sivun alalaidassa. (<em>Voit lähettää viestejä, Voit äänestää, jne.</em>) lista.'
	),
	array(
		0 => 'Kuinka muokkaan tai poista viestin?',
		1 => 'Mikäli et ole keskustelufoorumin ylläpitäjä tai valvoja. Voit muokata ja poistaa vain omia viestejäsi. Voit muokata viestiäsi (joskus vain rajoitetun ajan sen luomisen jälkeen) napsauttamalla <em>Muokkaa</em>-nappulaa valitsemastasi viestistä. Mikäli joku on jo vastannut viestiisi, siihen lisätään pieni teksti osoittamaan muokkauksen tapahtuneen, kun palaat lukemaan viestiä. Tässä on mukana myös lukumäärä, kuinka monta kertaa olet muokannut viestiä. Tämä näkyy vain, jos viestiin on jo vastattu ja se ei näy, jos valvoja tai ylläpitäjä muokkaa viestiä. (Heidän pitää itse jättää syy mitä on muokattu ja miksi). Huomaa, että normaali käyttäjä ei voi poistaa viestiä, jos siihen on vastattu.'
	),
	array(
		0 => 'Kuinka lisään allekirjoituksen?',
	...
	array(
		...
		1 => 'Liitetiedostojen lähetys on sallittu alue-, ryhmä- tai käyttäjäkohtaisesti. Keskustelufoorumin ylläpitäjä ei välttämättä anna lähettää liitetiedostoja kaikille alueille tai ehkäpä vain ylläpitäjien ryhmän annetaan lähettää liitetiedostoja. Ota yhteys ylläpitäjään, jos et ole varma miksi et voi lähettää liitteitä.'
	),
	array(
	...
	array(
		...
		1 => 'Mikäli ylläpitäjä sallii, katso sitä viestiä, jonka haluat ilmoittaa ja siinä pitäisi olla nappula, jolla voit ilmoittaa viestin. Tämän nappulan napsautus ohjaa eteenpäin ilmoittamisessa ja pyytää mahdolliset lisätiedot.'
	),
	array(
	...
	array(
		...
		1 => 'Napsauttamalla "Tönäise"-linkkiä voit tönäistä aloittamsi viestiketjun takaisin ensimmäiselle sivulle. Mikäli et näe tätä vaihtoehtoa, sen käyttö on estetty. Viestiä voi tönäistä myös kirjoittamalla siihen vastaus, mutta tästä kannattaa olla tarkkana, että noudatat foorumin sääntöjä.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Voit käyttää tätä listaa järjestelläksesi käyttäjiä. Ystävälistalla olevat henkilöt näytetään omissa asetuksissasi, jotta voit helposti katsoa ovatko he paikalla. Käytettävästä tyylistä riippuen näiden käyttäjien tekemät viestit voidaan myös korostaa. Mikäli laitat käyttäjän vihamieheksi, hänen kirjoittamiaan viestejä ei näytetä.'
	),
	array(
		0 => 'Kuinka voin lisätä ja poistaa käyttäjiä ystävien ja vihamiesten listoilta?',
		1 => 'Voit lisätä käyttäjiä kahdella tavalla: joko menemällä katsomaan käyttäjän profiilia ja napsauttamalla sieltä oikeaa linkkiä, tai vaihtoehtoisesti omista asetuksistasi. Voit lisätä käyttäjän myös kirjoittamalla suoraan hänen nimimerkkinsä. Samalla sivulla voit myös poistaa käyttäjiä.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Voit etsiä viestejä laittamalla haettavan sanan etusivulla, alueella tai viestien lukusivulla olevaan hakulaatikkoon. Voit etsiä tarkemmilla vaihtoehdoilla napsauttamalla "Tarkennettu haku" -linkkiä, joka on näkyvissä kaikilla keskustelufoorumin sivuilla.'
	),
	array(
		0 => 'Miksi hakutoiminto ei palauta yhtään tulosta?',
		1 => 'Käyttämäsi sana oli todennäköisesti epätarkka ja sisälsi liikaa yleisiä termejä, joita ei ole otettu mukaan phpBB3:n sisällysluetteloon. Koita tarkentaa hakuasi ja kokeile eri vaihtoehtoja.'
	),
	array(
	...
	array(
		...
		1 => 'Mene "käyttäjät" sivulle ja napsauta "Etsi käyttäjä" -linkkiä. Kun olet uudella sivulla, täytä tarvittavat kentät.'
	),
	array(
		0 => 'Kuinka löydän omat viestini ja aloittamani viestiketjut?',
		1 => 'Viestisi löytyvät napsauttamalla "Näytä viestit" -linkkiä omissa asetuksissasi tai profiilisivulla. Käytä hakusivulla olevia asetuksia hakeaksesi aloittamiasi viestiketjuja.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Tämän ohjelman on (alkuperäisessä muodossaan) julkaissut ja sen tekijänoikeuksien omistaja on <a href="https://www.phpbb.com/" target="_blank">phpBB Group</a>. Tämä on julkaistu GNU General Public Licence -lisenssin alaisena ja tätä voi levittää vapaasti. Katso linkistä lisätietoja.'
	),
	array(
		0 => 'Miksi toimintoa X ei ole saatavilla?',
		1 => 'Tämän ohjelmiston on tuottanut ja lisensoinut phpBB Group. Jos haluat lisätä ohjelmaan jonkun uuden toiminnallisuuden tai ilmoittaa ohjelmointivirheestä, käy <a href="https://www.phpbb.com/ideas/">phpBB:n ideakeskuksessa</a>, josta löytyy työkalut ilmoituksen ja ehdotuksen tekemiseen.'
	),
	array(
